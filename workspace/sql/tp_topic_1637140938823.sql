insert into tp_topic(id,created_at,deleted,updated_at,description,document_reference,max_student_take,min_student_take,name,task,thesis,council_id,semester_id,subject_department_id) values('1','2021-11-17 16:09:11.047771','false','2021-11-17 16:09:11.047771','Phát triển tiếp kết quả của nhóm đề tài K16 để xây dựng được thư viện và module điều khiển bay cho quadcopter có khả năng tích hợp thêm các cảm biến và module giao tiếp khác.
...
','false',null,'3','1');
insert into tp_topic(id,created_at,deleted,updated_at,description,document_reference,max_student_take,min_student_take,name,task,thesis,council_id,semester_id,subject_department_id) values('4','2021-11-17 16:11:24.937135','false','2021-11-17 16:11:24.937135','Hiện thực xe(robot) tự hành (prototype) có khả năng di chuyển theo tín hiệu đường và tránh vật cản di động.','Ros: https://www.ros.org/
Slam algorithms
http://gazebosim.org/
https://github.com/Introduction-to-Autonomous-Robots/Introduction-to-Autonomous-Robots 
...
','false',null,'3','1');
insert into tp_topic(id,created_at,deleted,updated_at,description,document_reference,max_student_take,min_student_take,name,task,thesis,council_id,semester_id,subject_department_id) values('6','2021-11-17 16:12:49.483065','false','2021-11-17 16:12:49.483065','Drone có khả năng nhận diện và tracking vật thể di động','Ros: https://www.ros.org/
http://gazebosim.org/
https://github.com/Introduction-to-Autonomous-Robots/Introduction-to-Autonomous-Robots 
...
','false',null,'3','5');
insert into tp_topic(id,created_at,deleted,updated_at,description,document_reference,max_student_take,min_student_take,name,task,thesis,council_id,semester_id,subject_department_id) values('9','2021-11-17 16:16:57.523767','false','2021-11-17 16:16:57.523767','Xây dựng môi trong mô phỏng cho việc truyền nhận dữ liệu LoRa, đo đạc các thông số liên quan đến năng lượng, thời gian hoạt động, đụng độ dữ liệu, mô phỏng năng lượng mặt trời cho việc cấp nguồn của hệ thống.
...
','false',null,'3','1');
insert into tp_topic(id,created_at,deleted,updated_at,description,document_reference,max_student_take,min_student_take,name,task,thesis,council_id,semester_id,subject_department_id) values('12','2021-11-17 16:19:13.001399','false','2021-11-17 16:19:13.001399','Nhu cầu và xu hướng tất yếu trong vấn đề theo dõi sức khỏe từ xa là tất yếu trong hiện tại cũng như tương lai. Hai chỉ số Oxy máu và ECG là các chỉ số sức khỏe quan trọng trong tầm soát và tiên đoán những dấu hiệu về sức khỏe cần có sự can thiệp của bác sĩ.
